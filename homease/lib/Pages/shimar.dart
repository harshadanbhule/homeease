...
void initState() {
  ...
  Future.delayed(const Duration(seconds: 4), () {
    Navigator.of(context).pushReplacement(
      PageRouteBuilder(
        transitionDuration: const Duration(milliseconds: 500), // fast fade
        pageBuilder: (context, animation, secondaryAnimation) => const CustomLoading(),
